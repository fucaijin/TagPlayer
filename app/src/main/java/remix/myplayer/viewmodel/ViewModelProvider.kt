...
val LocalDataAnalysisViewModel = compositionLocalOf<DataAnalysisViewModel> {
  error("DataAnalysisViewModel not provided")
}
...
fun ProvideViewModels(content: @Composable () -> Unit) {
  CompositionLocalProvider(
    ...
    LocalDataAnalysisViewModel provides activityViewModel()
  ) {
    content()
  }
}
...
val dataAnalysisViewModel: DataAnalysisViewModel
  @Composable
  @ReadOnlyComposable
  get() = LocalDataAnalysisViewModel.current
